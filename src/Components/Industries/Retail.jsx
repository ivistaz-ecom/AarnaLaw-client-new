...
import Retailimg from "../../images/Industries/Retail-banner.jpg";
...
function Retail() {
  ...
  const [selectedIndustry, setSelectedIndustry] = useState(translations[selectedLanguage].Retail);
  const [showContactForm, setShowContactForm] = useState(false);
  const location = useLocation();
  const isRetailIndustry = location.search.includes("Industryparam=retail");

  useEffect(() => {
    setSelectedIndustry(translations[selectedLanguage].Retail);
  }, [selectedLanguage]);
      ...
      <div className="industry-content">
        <div className="industry-dropdown">
          <IndustryList
            ...
            defaultItem={isRetailIndustry ? translations[selectedLanguage].Retail : selectedIndustry}
          />
        </div>

        <div className="industry-description">
          <p>{translations[selectedLanguage].Retail_Messpara1}</p>
          <p>{translations[selectedLanguage].Retail_Messpara2}</p>
          <p>{translations[selectedLanguage].Retail_Messpara3}</p>
        </div>

        <div className="industry-list">
          <ul>
            <li>{translations[selectedLanguage].Retails_MessList1}</li>
            <li>{translations[selectedLanguage].Retails_MessList2}</li>
            <li>{translations[selectedLanguage].Retails_MessList3}</li>
            <li>{translations[selectedLanguage].Retails_MessList4}</li>
            <li>{translations[selectedLanguage].Retails_MessList5}</li>
          </ul>
        </div>
