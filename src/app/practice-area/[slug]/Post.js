            ...
            data.map((post) => (
              <div className="flex flex-col pb-10" key={post.id}>
                ...
                <img
                  ...
                  className="w-full img-fluid rounded-5 mb-5"
                />

                {/* Content and Partner Image Layout */}
                <div className="flex flex-wrap container mx-auto px-4 text-justify justify-center">
                  {/* Left Column: Content */}
                  <div className="w-full md:w-[800px]  border-b-4 border-red-500 pb-10 md:mr-10">
